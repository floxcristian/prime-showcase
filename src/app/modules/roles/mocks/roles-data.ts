...
export const ROLES_DATA: Role[] = [
  {
    id: 1,
    name: 'Admin',
    description: 'Acceso administrativo completo a todos los módulos del sistema',
    type: 'Sistema',
    userCount: 3,
    status: 'Activo',
  ...
  },
  {
    id: 2,
    name: 'Auditor',
    description: 'Acceso de solo lectura a todos los módulos para tareas de auditoría y compliance',
    type: 'Sistema',
    userCount: 5,
    status: 'Activo',
  ...
  },
  {
    id: 3,
    name: 'Developer',
    description: 'Acceso técnico — admin en observabilidad y administración, write en módulos operativos',
    type: 'Sistema',
    userCount: 7,
    status: 'Activo',
  ...
  },
  {
    id: 4,
    name: 'Soporte',
    description: 'Atención al cliente — modificar tickets de postventa, consultar clientes y pedidos',
    type: 'Sistema',
    userCount: 12,
    status: 'Activo',
  ...
  },
  {
    id: 5,
    name: 'Operaciones',
    description: 'Gestión de pedidos, inventarios, logística y bodegas',
    type: 'Sistema',
    userCount: 8,
    status: 'Activo',
  ...
  },
  {
    id: 6,
    name: 'Comercial',
    description: 'Ventas, gestión de clientes y campañas de marketing',
    type: 'Sistema',
    userCount: 14,
    status: 'Activo',
  ...
  },
  {
    id: 7,
    name: 'Integrador',
    description: 'Acceso programático para integraciones externas — APIs, webhooks, observabilidad',
    type: 'Sistema',
    userCount: 4,
    status: 'Activo',
  ...
  },
  {
    id: 8,
    name: 'Consultor',
    description: 'Acceso de lectura a módulos comerciales y operativos para análisis y reportes',
    type: 'Sistema',
    userCount: 2,
    status: 'Activo',
  ...
  },
  {
    ...
    description: 'Role personalizado para demostraciones — solo lectura en CRM y catálogo',
    type: 'Personalizado',
    userCount: 0,
    status: 'Inactivo',
